    ...
    <PageWrapper>
      ...
      <section className="section" style={{ textAlign: 'center', paddingBottom: 'var(--space-4)' }}>
        <div className="container">
          <span className="label" style={{ color: 'var(--apex-primary)', marginBottom: 'var(--space-2)', display: 'block', letterSpacing: '0.12em' }}>
            OUR BACKGROUND
          </span>
          <h1 className="display-xl" style={{ color: 'var(--apex-text-white)', marginBottom: 'var(--space-3)' }}>
            How APEX Began
          </h1>
          <p className="body-lg" style={{ color: 'var(--apex-text-muted)', maxWidth: '640px', margin: '0 auto', lineHeight: 1.6 }}>
        ...
        <div className="container">
          <div style={{ display: 'grid', gridTemplateColumns: '1.2fr 0.8fr', gap: 'var(--space-6)', alignItems: 'center' }} className="grid-2">
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-4)' }}>
              <p className="body-md" style={{ color: 'var(--apex-text-muted)', lineHeight: 1.75 }}>
              ...
              <p className="body-md" style={{ color: 'var(--apex-text-muted)', lineHeight: 1.75 }}>
                To solve this, we launched the <strong style={{ color: 'var(--apex-text-white)', fontWeight: 600 }}>APEX AI Launchpad (AAL)</strong> internship. Today, APEX represents a unified platform housing our dual efforts—bridging industry talent with growth circles.
              </p>
            </div>
            ...
            <div style={{ 
              ...
              <h3 className="heading-sm" style={{ color: 'var(--apex-primary)', marginBottom: 'var(--space-2)' }}>Grassroots Innovation</h3>
              <p className="body-sm" style={{ color: 'var(--apex-text-muted)', marginBottom: 'var(--space-4)', lineHeight: 1.6 }}>
        ...
        <div className="container">
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 'var(--space-4)' }} className="grid-2">
            ...
            <article style={{ background: 'var(--apex-bg-surface)', border: '1px solid var(--apex-border-dark)', borderRadius: 'var(--radius-lg)', padding: 'var(--space-5)', boxShadow: 'var(--shadow-sm)' }}>
              <h2 className="heading-sm" style={{ color: 'var(--apex-primary)', marginBottom: 'var(--space-3)' }}>Our Mission</h2>
              <p className="body-md" style={{ color: 'var(--apex-text-muted)', margin: 0, lineHeight: 1.7 }}>
            ...
            {/* Vision Card */}
            <article style={{ background: 'var(--apex-bg-surface)', border: '1px solid var(--apex-border-dark)', borderRadius: 'var(--radius-lg)', padding: 'var(--space-5)', boxShadow: 'var(--shadow-sm)' }}>
              <h2 className="heading-sm" style={{ color: 'var(--apex-primary)', marginBottom: 'var(--space-3)' }}>Our Vision</h2>
              <p className="body-md" style={{ color: 'var(--apex-text-muted)', margin: 0, lineHeight: 1.7 }}>
